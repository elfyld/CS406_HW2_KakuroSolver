    ...
    if ((s.dir == d_down && col == s.start.second && row >= s.start.first && row < s.end.first) ||
      ...
      if (s.dir == d_down) {
        ...
        for (int i = s.start.first; i < s.end.first; i++) {
          ...
          if (((col== s.end.second - 1) && (s.dir == d_right)) || ((s.dir == d_down) && (row == s.end.first - 1))) {
            last_cell = true;
          }
        }
      } else {
        ...
        for (int j = s.start.second; j < s.end.second; j++) {
          ...
          if (((col== s.end.second - 1) && (s.dir == d_right)) || ((s.dir == d_down) && (row == s.end.first - 1))) { //if I am not at the end of the column and there exist -2 I am not in last cell
            last_cell = true;
          }
        }
      }
